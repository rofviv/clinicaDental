...
public class FormEditarDentista extends javax.swing.JDialog {
    ...
    public FormEditarDentista(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        llenarEspecialidades();
    }
    
    public void llenarCampos(String ci, String nombre, String apell, String dir, String fNac, String fIng, String genero,
            String cel, String fijo, String ciu, String email) {
        this.ci = Integer.parseInt(ci);
        txtCI.setText(ci);
        txtNombre.setText(nombre);
        txtApellidos.setText(apell);
        txtFecha.setText(fNac);
        txtIngreso.setText(fIng);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormEditarDentista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormEditarDentista dialog = new FormEditarDentista(new javax.swing.JFrame(), true);
